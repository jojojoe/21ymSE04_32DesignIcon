...
class DIynymPurchaseManagerLink: NSObject {
    static let `default` = DIynymPurchaseManagerLink()
        ...
        buyManage.callBackBlock = { transaction in
            ...
            case .purchased:
                ...
                if let model = self.currentBuyModel {
                    ...
                    // new add
                    DIynymCoinManagr.default.addCoin(coin: model.coin)
