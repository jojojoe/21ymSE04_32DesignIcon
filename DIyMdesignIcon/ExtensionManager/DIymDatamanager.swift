...
struct DICymStickerItem: Codable {
...
//}
//
class DICymDataManager: NSObject {
    static let `default` = DICymDataManager()
    
//    var filterList : [GCFilterItem] {
//        return DICymDataManager.default.loadPlist([GCFilterItem].self, name: "FilterList") ?? []
//    }
    
    var iconList : [DICymStickerItem] {
        return DICymDataManager.default.loadJson([DICymStickerItem].self, name: "icon") ?? []
    }
